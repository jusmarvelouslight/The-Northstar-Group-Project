...
|     T14     |     Write a   3-scenario demo script (Order Status success, Returns success, fallback   trigger) with exact sample inputs       |     Angela                    |     P1            |     Friday               |     At least 2 realistic customer scenarios can be   demonstrated from start to finish                               |     Not Started    |     1.5 hrs        |
