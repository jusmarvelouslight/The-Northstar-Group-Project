...
|     T03     |     Journey map   covering: initiate → eligibility check → refund method → confirmation, as 1   flowchart                       |     Angela                    |     P0            |     Wednesday            |     Complete return/refund flow documented including refund   expectations and fallback cases                        |     Not Started    |     2 hrs          |
...
|     T05     |     Draft intent   list + sample utterances for Order Status only (8–10 intents)                                                |     Angela                    |     P0            |     Wednesday            |     Conversation branches, inputs, responses and fallback   paths are documented                                     |     Not Started    |     2hrs           |
...
|     T07     |     Wire Order   Status intent to return a hardcoded response for 1 test order ID                                               |     Regina+     all members    |     P0            |     Thursday             |     User can ask about an order and receive an appropriate   status response through the chatbot                     |     Not Started    |     3 hrs          |
...
|     T11     |     Run the 8 Order   Status test cases against the live bot, log pass/fail + notes                                             |     all members                |     P0            |     Thursday             |     All core flows tested and failures recorded in a bug list                                                        |     Not Started    |     1.5 hrs        |
